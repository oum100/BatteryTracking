...
<template>
  ...
  >
    <div class="flex items-start justify-between gap-4 sm:gap-6">
      <div class="text-[11px] font-black uppercase tracking-[0.18em] opacity-70 sm:text-xs sm:tracking-[0.22em]">Select Mode</div>
      <div
    ...
    <div class="mt-4 text-[1.2rem] font-black leading-[1.05] tracking-[-0.03em] sm:mt-5 sm:text-[1.85rem] lg:text-[1.95rem]">
      {{ label }}
    </div>
    <div class="mt-2 text-[0.92rem] font-semibold leading-snug opacity-90 sm:mt-3 sm:text-[0.98rem] lg:text-[1rem]">
      {{ detail }}
    </div>
  </button>
</template>
